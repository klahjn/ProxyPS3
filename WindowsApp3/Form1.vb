...
Imports System.Net
Public Class Form1
    Dim var1 As String = "\resources\ps3proxy.exe", var2 As String = "\resources\ps3help.pdf", var3 As String = "netsh advfirewall firewall add rule name=""Open Port 8080"" dir=in action=allow protocol=TCP localport=8080"
    Public myProcess As Process
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'My.Settings.FirstRun = 0 'this is for diagnostics
        If My.Settings.FirstRun = "0" Then
            ...
            firewallrule() : My.Settings.FirstRun = "1" : My.Settings.Save()
        End If
        ...
        Label1.Text = localipp() + ":8080" : Me.Text = Me.Text + " " + Application.ProductVersion.ToString : Me.Width = 260
    End Sub
    Private Sub firewallrule()
        Dim psi As New ProcessStartInfo()
        psi.Verb = "runas" : psi.WindowStyle = ProcessWindowStyle.Hidden : psi.FileName = "cmd.exe" : psi.Arguments = " /c " + var3
        Try
            Process.Start(psi)
        Catch
